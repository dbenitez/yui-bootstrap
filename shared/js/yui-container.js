...
(function () {
    ...
    * @type String
    */
    Module.CSS_HEADER = "modal-header";
    ...
    * @type String
    */
    Module.CSS_FOOTER = "modal-footer";
    ...
    */
    ...
    function createModuleTemplate() {
        ...
        if (!m_oModuleTemplate) {
            ...
            m_oModuleTemplate.innerHTML = ("<div class=\"" +
                Module.CSS_HEADER + "\"><h3></h3></div>" + "<div class=\"" +
    ...
    function createHeader() {
        ...
        return (m_oHeaderTemplate.cloneNode(true));
    }
    ...
    Module.prototype = {
        ...
        */
        setHeader: function (headerContent) {
            ...
            var oH = oHeader.getElementsByTagName('H3')[0];
            if (headerContent.nodeName) {
            	oH.innerHTML = "";
            	oH.appendChild(headerContent);
            } else {
            	oH.innerHTML = headerContent;
            }
...
(function () {
    ...
    * @type String
    */
    Panel.CSS_PANEL_CONTAINER = "yui-panel-container modal";
            ...
            if (val) {
                if (!oClose) {
                    ...
                    if (!m_oCloseIconTemplate) {
                        m_oCloseIconTemplate = document.createElement("button");
                        m_oCloseIconTemplate.type = "button";
                        m_oCloseIconTemplate.className = "close";
                        m_oCloseIconTemplate.setAttribute('aria-hidden',true);
                        m_oCloseIconTemplate.setAttribute('data-dismiss',"modal");
                    ...
                    var oH = this.header.getElementsByTagName('H3')[0];
                    if (oH) {
                        //this.innerElement.insertBefore(oClose, fc);
                    	this.header.insertBefore(oClose,oH);
                    } else {
                        this.header.insertBefore(oClose,this.header.firstChild);
                    }

                    oClose.innerHTML = (strings && strings.close) ? strings.close : "&times;";
            ...
            if (Lang.isArray(aButtons)) {
                ...
                for (i = 0; i < nButtons; i++) {
                    ...
                    if (Button) {
                        ...
                        oButtonEl.className = "btn";
                        if (oButton.isDefault) {
                        	Dom.addClass(oButtonEl,"btn-primary")
                            this.defaultHtmlButton = oButtonEl;
                        }
